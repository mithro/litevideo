...
Date: 2026-09-07 05:08 ACST. Host: `tim@rpi5-netv2.welland.mithis.com`. Bitstream: `kosagi_netv2.bit` (SHA-256 `3f671c023ba5297863fbf45301f038fd850527c4a7f796b42f3b8fe48f046783`), volatile JTAG load.

| Check | Result | Detail |
|---|---|---|
| transmitter running | PASS | status=0xd0104 frames=573 |
