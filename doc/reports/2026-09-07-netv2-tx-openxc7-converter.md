...
Date: 2026-09-07 05:35 ACST. Host: `tim@rpi5-netv2.welland.mithis.com`. Bitstream: `kosagi_netv2.bit` (SHA-256 `8df757ebbdafdfbde784fc6b1b764ac2653f885283be883f249ed816ec40c4fa`), volatile JTAG load.

| Check | Result | Detail |
|---|---|---|
| transmitter running | PASS | status=0xd0104 frames=366 |
